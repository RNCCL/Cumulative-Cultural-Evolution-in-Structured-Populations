...
output_filename = (f'{topology}_{transmission_rule}_{average_degree}.npz' if r is None else f'{topology}_{transmission_rule}_{average_degree}_r{r}.npz')
...
save_data = dict(
    ...
    average_degree_maximum_cultural_complexity = np.mean(maximum_cultural_complexities)
)
